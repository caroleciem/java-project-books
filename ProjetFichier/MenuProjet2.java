...
public class MenuProjet2 {


    public static void main(String[] args) throws FileNotFoundException {
        // Arraylist des fichiers traités
        ...
        for (int i = 0; i < args.length; i++) {
            ...
            //je créé les fichiers Prétraités
            nom = args[i];
            PreTraitement.traitement(nom);
...
//fonction pour supprimer un fichier dans ma liste
    ...
    public static boolean validationDuChoix(int choix, ArrayList listeFichiers) throws FileNotFoundException {
                    ...
                    while (livreSel == false) {
                        ...
                        try {
                            ...
                            if (livre > listeFichiers.size() || livre == 0) {
                                ...
                                MenuLivres2.menuLivres(listeFichiers, livre - 1);
                            }
                        } catch (InputMismatchException e) {
                            System.out.println("ce n'est pas un entier !");
                            clavier.nextLine();
